...
-- CreateEnum
CREATE TYPE "public"."ReportType" AS ENUM ('SALES_SUMMARY', 'PAYMENT_ANALYSIS', 'CUSTOMER_ANALYSIS', 'PRODUCT_PERFORMANCE', 'MONTHLY_REVENUE', 'QUARTERLY_REPORT', 'YEARLY_REPORT');
...
-- AddForeignKey
ALTER TABLE "public"."InvoiceReport" ADD CONSTRAINT "InvoiceReport_invoiceId_fkey" FOREIGN KEY ("invoiceId") REFERENCES "public"."Invoice"("id") ON DELETE CASCADE ON UPDATE CASCADE;
