...
const mockReviews = [
  ...
  },
  {
    ...
    response: {
      content:
        "Thank you for your feedback! We apologize for the delay and have improved our delivery process.",
  ...
  },
  {
    ...
    response: {
      content:
        "We're so happy you loved the arrangement! Thank you for choosing MiskBlooming for your special event.",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-foreground ">Total Reviews</p>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-foreground ">Pending Reviews</p>
          ...
          {[5, 4, 3, 2, 1].map((rating) => (
            <div key={rating} className="flex items-center space-x-4">
              ...
              <div className="flex-1 h-3 bg-gray-200 rounded-full">
                <div
                  className="h-3 bg-foreground 0 rounded-full"
                  style={{
                    width: `${
                      (stats.distribution[
