                ...
                >
                  <item.icon
                    className={`w-5 h-5 mr-3 ${
                      isActive ? "text-luxury-600" : "text-gray-400 group-hover:text-gray-600"
                    }`}
                  />
                  ...
                  {isActive && <div className="w-2 h-2 bg-luxury-500 rounded-full"></div>}
                </Link>
              )
            })}
          </nav>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="ml-3 flex-1 text-left">
                  ...
                  <p className="text-xs text-gray-500">admin@miskblooming.ae</p>
                </div>
                <ChevronDown
