...
export const metadata: Metadata = {
  ...
  keywords: "luxury flowers, premium gifts, flower delivery, elegant arrangements, corporate gifting, bespoke florals",
  authors: [{ name: "MiskBlooming" }],
  openGraph: {
    title: "MiskBlooming - Luxury Flowers & Exquisite Gifts",
    description: "Experience the pinnacle of floral artistry with premium arrangements and luxury gifts.",
    type: "website",
    locale: "en_US",
  },
}
