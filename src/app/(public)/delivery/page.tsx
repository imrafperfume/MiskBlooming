...
export default function MiskBloomingShipping({ lastUpdated = "Oct 10, 2025" }) {
  return (
    <section className="max-w-4xl mt-14 mx-auto p-6 bg-white shadow-lg rounded-2xl border border-gray-100">
      ...
      <div className="space-y-6">
        <article className="bg-gray-50 p-4 rounded-lg border border-gray-100">
          ...
          <ul className="mt-3 grid sm:grid-cols-2 gap-2 text-gray-700">
            <li className="px-3 py-2 bg-white rounded-md shadow-sm">
        ...
        <article className="bg-gray-50 p-4 rounded-lg border border-gray-100">
          ...
          <div className="mt-3 grid sm:grid-cols-2 gap-4 text-gray-700">
            ...
            <div className="sm:col-span-2 bg-white p-3 rounded-md border">
